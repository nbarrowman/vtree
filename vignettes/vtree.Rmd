---
title: "Introduction to vtree 1.2.2"
...
## Special variable specifications

There are several special ways to specify variables in a call to `vtree`.

### `is.na:` - Replacing a variable with a missing value indicator
...
### `stem:` - Variable stems for REDCap checkboxes

This is described in the REDCap section later in this vignette.

```{r, eval=FALSE}
This is described [later](#REDCap-checkboxes).
```

### `variable=value` - Dichotomizing based on a specific value

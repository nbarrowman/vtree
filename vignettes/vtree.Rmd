...
For example, when pruning `Severity` nested within levels of `Sex`,
the pruning takes place in both the M and F branches.
...
Their arguments are more elaborate because they specify the path from the

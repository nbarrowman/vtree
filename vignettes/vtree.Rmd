---
title: "Introduction to vtree 2.1.9"
...
`vtree` provides an intuitive way to explore a data set, 
construct flow diagrams for reports and publications,
and to double-check an analysis to ensure that subsetting has been performed correctly.

---
title: "Introduction to vtree 4.6.1"
...
i.e. the denominator used to calculate a percentage is
...
`r spaces(40)`
`r vtree(FakeData,"Severity Sex", pxwidth=1000,imageheight="3.5in")`
...
*This section shows how to alter variables for use in a variable tree.* 
...
*This sections shows how to display additional information in nodes.*
...
Sometimes it is useful to extract counts or percentages from a variable tree. 

---
title: "Introduction to vtree 2.4.6"
...
(i.e. percentages calculated using the number of non-missing observations as denominator,
...
when `vp=TRUE`
(meaning that valid percentages are shown, which is the default), 
...
When `vp=FALSE`, missing nodes may be pruned (if they are small).

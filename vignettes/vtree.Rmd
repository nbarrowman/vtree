---
title: "Introduction to vtree 1.1.8"
...
To see where manual calculation of nested subsets can go wrong,
consider study flow diagrams, which involve nested subsets such as
...
When most cells of a contingency table are empty (known as a *sparse* table),

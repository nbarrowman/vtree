---
title: "Introduction to vtree 4.4.2"
...
`r vtree(FakeData,"Severity Sex",prune=list(Severity=c("Mild","Moderate")),
  width=500,height=300,pxwidth=500,imageheight="2.5in")`
...
### prefixes for REDCap datasets: `stem:`, `rc:` and `any:` (with no suffix)
...
`r vtree(FakeData,"Severity",summary="Score",horiz=FALSE,
  width=450,height=150,pxwidth=1200,imageheight="2.7in")`
...
`r vtree(FakeData,summary="Category",
  width=500,height=300,pxwidth=300,imageheight="1in")`
...
`r vtree(FakeData,"Severity",summary="Category=single",horiz=FALSE, 
  width=450,height=150,pxwidth=1400,imageheight="1.3in")`
...
`r vtree(FakeData,"Severity",summary="Ind*",sameline=TRUE,horiz=FALSE,just="l",
  width=450,height=150,pxwidth=1100,imageheight="2.2in")`
...
To see the means without any decimals, specify `cdigits=0`.
...
Alternatively, the `%list_%` code can be used to put each value on a new line.
...
`r vtree(FakeData,"Severity Category",
  summary="(Post-Pre)/Pre \nmean = %mean%",sameline=TRUE,horiz=FALSE,cdigits=1,
  width=450,height=150,pxwidth=1000,imageheight="1.8in")`
...
`r vtree(FakeData,"Severity",horiz=FALSE,showvarnames=FALSE,splitwidth=Inf,sameline=TRUE,
  summary=c(
    ...
    "Pre \nPre: range %range%"),
  width=650,height=350,pxwidth=1400,imageheight="1.4in")`

---
title: "Introduction to vtree 1.2.1"
...
### Replacing specified variables with missing value indicators

Specifying individual variable names with the prefix `na:`
replaces them with a missing value indicator in the variable tree.
(This differs from the `check.is.na` parameter,

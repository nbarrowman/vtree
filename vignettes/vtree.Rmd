---
title: "Introduction to vtree 1.3.3"
...
The following codes can be used by `summary`:
...
```
```{r,echo=FALSE}
v29 <- vtree(FakeData,"Severity",edgeattr="arrowhead=none penwidth=2",
  sameline=TRUE,width=250,height=250)
...
```
```{r,echo=FALSE}
v30 <- vtree(FakeData,"Severity",nodeattr="width=2",
  sameline=TRUE,width=250,height=250)

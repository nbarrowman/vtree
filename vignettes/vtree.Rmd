---
title: "Introduction to vtree 1.1.4"
...
Nested subsets help us to answer questions like:

* Among African countries with a population over 30 million, what proportion are landlocked?

* What is the average GDP in non-African countries with populations under 10 million?

Even in a simple situations like this,
it can be a chore to keep track of nested subsets.
If there are missing values in the data set,
the task becomes even more complicated.
Finally, as the number of nested subsets increases,
the magnitude of the task grows rapidly.
For these reasons,
manual calculation of nested subsets of a data set is problematic.

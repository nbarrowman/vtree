---
title: "Introduction to vtree 1.0.6"
...
```{r,eval=FALSE}
vtree(FakeData,"Sex Category",sameline=TRUE,splitwidth=150,varminwidth=c(Category=7),
  summary=c(
...
```
```{r,echo=FALSE}
v13b <- vtree(FakeData,"Sex Category",sameline=TRUE,splitwidth=150,varminwidth=c(Category=7),

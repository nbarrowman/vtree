...
* `%list%` comma-separated list of individual values
...
### Multi-way intersections (often shown in Venn diagrams) {#Venn}
...
### A different way of showing Venn diagram information {#patterns}

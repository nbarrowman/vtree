---
title: "Introduction to vtree 2.2.8"
...
`r vtree(FakeData,"Ind1 Ind2 Ind3 Ind4",Venn=TRUE,pattern=TRUE,
  width=650,height=650,pxwidth=800,imageheight="6in")`
...
(In the example above, in the call to `print`, quotation marks are suppressed.
...
```{r}
print(VennTable(vtree(FakeData,"Severity Age Pre Post",check.is.na=TRUE,ptable=TRUE)),quote=FALSE)
```

---
title: "Introduction to vtree 4.1.9"
...
In this case,
a variable tree for subsets of `df` based on values of `v2` nested within values of `v1` can be displayed using the following command:

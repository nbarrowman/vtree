---
title: "Introduction to vtree 2.4.4"
...
Note that when `keep` is used, missing value nodes will always be retained,
since if they were not, valid percentages would be confusing.

---
title: "Introduction to vtree 4.2.9"
...
This provides a quick demonstration of `vtree` but tends not to be especially
informative.
...
The `summary` parameter also allows for a more customized specification.
...
### How to specify the `summary` argument

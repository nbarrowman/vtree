---
title: "Introduction to vtree 1.1.2"
...
Contingency tables can be less intuitive, especially when they involve more than two variables.
...
Variable trees can be used for quick explorations of a data set,
for figures to include in publications, 
and also for double checking the results of subsetting operations in code.

---
title: "Introduction to vtree 2.2.0"
...
`r vtree(df,"continent population landlocked",showroot=FALSE)`
...
cat(vtree(FakeData,"Severity Sex",showlegend=FALSE,horiz=FALSE,
  width=600,height=200,pxwidth=800,imageheight="2.2in"))
```
...
`r vtree(FakeData,"Severity",width=250,height=250,pxwidth=1000,imageheight="2.5in")`

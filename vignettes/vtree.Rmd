---
title: "Introduction to vtree 1.4.0"
...
Pattern&nbsp;&nbsp;&nbsp;&nbsp; |`Ind1` | `Ind2` | `Ind3` | `Ind4` | Frequency
--------|-------|--------|--------|--------|----------------
`r paste(gsub("[|]",",",names(table(pattern))),"|", paste0(names(table(pattern)),"|",table(pattern)),collapse="\n")`

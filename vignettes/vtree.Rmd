---
title: "Introduction to vtree 4.0.7"
...
By default, missing values are reported, using the abbreviation `mv`.
An alternative is to use the code `%meanx%`,
which does not report missing values.

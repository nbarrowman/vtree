---
title: "Introduction to vtree 2.1.2"
...
## Using vtree in R Markdown {#embeddingPNG}
...
Let's examine the mean number of cases among patients
aged 75 and older compared to the rest of the patients:

```{r, eval=FALSE}
vtree(esoph,"agegp=75+",
  summary="ncases \nmean cases=%mean%%leafonly%",sameline=TRUE)
```
...
```{r, eval=FALSE}
vtree(mt,"cyl gear carb",summary="hp \nmean (SD) HP %mean% (%SD%)%var=pattern%",
  labelvar=c(cyl="# cylinders",gear="# gears",carb="# carburetors"),pattern=TRUE)
```
...
vtree(ChickWeight,"Diet Time",keep=list(Time=c("0","4")),
  labelnode=list(Diet=c("Diet 1"="1","Diet 2"="2","Diet 3"="3","Diet 4"="4")),

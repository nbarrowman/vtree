---
title: "Introduction to vtree 3.0.6"
...
but you need to (1) use the chunk option `results="asis"`,
and (2) specify `asis=TRUE` in the `vtree` call:
...
Or you can use a code chunk,
but you need to (1) specify `pngknit=FALSE` in the `vtree` call:

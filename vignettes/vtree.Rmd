---
title: "Introduction to vtree 1.1.1"
...
```{r,eval=FALSE}
vtree(FakeData,"Severity Age Pre Post",check.is.na=TRUE,seq=TRUE,showroot=FALSE,
  palette=c(Severity=1,Age=2,Pre=3,Post=4))
```
```{r,echo=FALSE}
v25 <- vtree(FakeData,"Severity Age Pre Post",check.is.na=TRUE,seq=TRUE,showroot=FALSE,
  palette=c(Severity=1,Age=2,Pre=3,Post=4))
